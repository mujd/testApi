...
class PerfilType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $competencia = new Client();
        $competencias = $competencia->request('GET', 'http://138.197.7.205/gt/api/web/competenciaConductual');
        $dataComp = json_decode($competencias->getBody()->getContents(), true);
